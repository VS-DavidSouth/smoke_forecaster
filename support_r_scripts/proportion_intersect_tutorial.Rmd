...
Now we want to use the apply family of functions over all grids in the county (and for all counties in the state). The first step is to create a function that pulls out each unique sf object and puts it in a list. We'll eventually do this for all counties in a state.
